...
local drag = false
local rect1, rect2, poly, circl, width
local font = love.graphics.newFont(20)

function love.load()
	width = love.graphics.getDimensions()
	rect1 = rectangle.new(100, 100, 75, 75)
	rect2 = rectangle.new(400, 100, 150, 150)
	poly = polygon.new(
		point.new(630, 400),
		point.new(670, 400),
		point.new(700, 450),
...
function love.draw()
	...
	love.graphics.printf(
		"Drag a smaller magenta rectangle over the shapes.",
		0,
		20,
		width,
		"center"
	...
	if polysec.overlap(circl, rect1) then
		r1mode = "fill"
	end
	love.graphics.setColor(1, 0, 0.4314)
	love.graphics.rectangle(r1mode, rect1[1], rect1[2], 75, 75)
	love.graphics.reset()
end
